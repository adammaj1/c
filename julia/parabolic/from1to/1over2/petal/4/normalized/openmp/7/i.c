...
int SaveArray2PGMFile( unsigned char A[], double k, char* text)
{
  ...
  char *comment= strncat("#" , text, sizeof text); /* comment should start with # */
...
int main(){
 ...
 SaveArray2PGMFile(Fatou, 5.0+AR, "Fatou components, Julia set, immediate basin of parabolic fixed point alfa, attracting petal ");
