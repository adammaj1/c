...
int main(){
 ...
 MarkImmediateBasin(iPeriodChild, iBasin, Julia, Basin );
 SaveArray2PGMFile(Basin, 4.0+AR, "Fatou components, Julia set, immediate basin of parabolic fixed point alfa ");
