...
#define iMaxDistance2Alfa  1500 // distance point to alfa fixed point in pixels  150 when iHeight=1000; 280 when iHeight=2000
...
static unsigned int iHeight = 10000; //  odd number !!!!!! = (iyMax -iyMin + 1) = iyAboveAxisLength + iyBelowAxisLength +1
