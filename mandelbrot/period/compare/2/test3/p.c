...
long double GivePixelWidth(unsigned int period)
{
 ...
 {
   case   1 : w=0.1L  ; break;
   case   2 : w=0.03L ; break;
   case   4 : w=0.007L; break;
   case   8 : w=0.0003L; break;
   case  16 : w=0.1L; break;
   default : w=0.003L;
 }
...
fprintf(fp," Linear scale with fixed step = PixelWidth       = %.20Lf \n", PixelWidth);
