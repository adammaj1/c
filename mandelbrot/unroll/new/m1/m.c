...
#define dSide 0.3333
#define KxMin 0.0
#define KxMax (m*dSide)
#define KyMin 0.0
#define KyMax dSide
/* (KxMax-KxMin)/(KyMax-KyMin)==iXmax/iYmax = 1 */

#define IterationMax (iXmax*100) /* proportional to resolution of picture */

#define PixelWidth  ((KxMax-KxMin)/iXmax)
#define PixelHeight ((KyMax-KyMin)/iYmax)

double distanceMax ; //= PixelWidth; /* proportional to pixel size */
